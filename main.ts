 ...
 interface person {
    name: string;                 // name of the person data type = string
    dateOfBirth: string;          // Date of birth of the person data type = string
    children: number;             // How many children that person has data type = number
    country: string;              // What country that person is from. data type = string
    knowsProgramming: boolean;    // if that person knows programming or not = boolean
 }
...
// comparing age
const firstPersonDateOfBirth: Date = new Date(people[0].dateOfBirth); // getting the age of the first person      
const lastPersonDateOfBirth: Date =  new Date(people[people.length-1].dateOfBirth); // getting the age of the last person

const currentDate: Date = new Date(); // getting the current date

const firstPersonAge: number = currentDate.getFullYear() - firstPersonDateOfBirth.getFullYear(); //new variable the gets the full year and minuses the first person date of birth to get the age

const lastPersonAge: number = currentDate.getFullYear() - lastPersonDateOfBirth.getFullYear(); //new variable the gets the full year and minuses the second person date of birth to get the age
...
// comparing kids
const secondPersonKids: number = people[1].children; // Here i am creating a variable that is a number and it goes to the "people" array and gets the children number for the second person
const thirdPersonKids: number = people[2].children; // Here i am creating a variable that is a number and it goes to the "people" array and gets the children number for the third person
...
const firstPersonCoding: boolean = people[0].knowsProgramming;
const fourthPersonCoding: boolean = people[3].knowsProgramming;
...
const secondPersonCountry: string = people[1].country;
